...
var MonthView = (function(_React$Component) {
  ...
  MonthView.prototype.measureRowLimit = function measureRowLimit() {
    var _refs$slotRow$getRowM = this.refs.slotRow.getRowMetrics(),
      eventHeight = _refs$slotRow$getRowM.eventHeight,
      rowLimit = _refs$slotRow$getRowM.rowLimit,
      leftoverSpace = _refs$slotRow$getRowM.leftoverSpace
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderWeek = function(week, weekIdx) {
    ...
    var _state = _this4.state,
      ...
      leftoverSpace = _state.leftoverSpace,
      eventHeight = _state.eventHeight
