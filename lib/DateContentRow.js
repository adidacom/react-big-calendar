...
var propTypes = {
  ...
  leftoverSpace: _propTypes2.default.number,
  eventHeight: _propTypes2.default.number,
}
...
var DateContentRow = (function(_React$Component) {
  ...
  DateContentRow.prototype.getRowMetrics = function getRowMetrics() {
    ...
    var actualRowLimit = Math.floor(eventSpace / eventHeight)
    var boundedRowLimit = Math.max(actualRowLimit, 1)
    var eventLevelsLimit = Math.max(actualRowLimit, 1)
    var leftoverSpace = eventSpace - eventLevelsLimit * eventHeight
  ...
  DateContentRow.prototype.render = function render() {
    var _props = this.props,
      ...
      leftoverSpace = _props.leftoverSpace,
      eventHeight = _props.eventHeight

    var renderedEvents = void 0
    ...
    if (renderForMeasure) {
      ...
      var eventRowProps = {
        ...
        slotMetrics: {
          ...
          continuesPrior: function continuesPrior() {
            return false
          },
          continuesAfter: function continuesAfter() {
            return false
          },
        },
      }

      renderedEvents = _react2.default.createElement(
        WeekWrapper,
      ...
      renderedEvents = _react2.default.createElement(
        WeekWrapper,
        _extends({ isAllDay: isAllDay }, _eventRowProps),
        levels.map(function(segs, idx) {
          return _react2.default.createElement(
            _EventRow2.default,
            _extends({ key: idx, segments: segs }, _eventRowProps)
          )
        }),
        !!extra.length &&
          _react2.default.createElement(
