...
var EventEndingRow = (function(_React$Component) {
  ...
  EventEndingRow.prototype.render = function render() {
    var _props = this.props,
      ...
      slots = _props.slotMetrics.slots
    ...
    while (current <= slots) {
      ...
      if (this.canRenderSlotEvent(left, span)) {
        ...
        if (gap) {
          row.push(_EventRowMixin2.default.renderSpan(slots, gap, key + '_gap'))
        }
  ...
  EventEndingRow.prototype.canRenderSlotEvent = function canRenderSlotEvent(
    ...
    return (0, _range2.default)(slot, slot + span).every(function(s) {
      ...
      var roomForEvent = _this2.props.leftoverSpace > _this2.props.eventHeight
...
EventEndingRow.defaultProps = _extends(
  {},
  _EventRowMixin2.default.defaultProps,
  {
    eventHeight: 25,
  }
)
